...
It is designed to work **standalone** or on top of the [MotionSensor](https://github.com/10ish01/Motion_Control-ESP) library, making it easy to integrate into existing projects.
